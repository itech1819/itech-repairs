...
export const metadata: Metadata = {
  title: 'LG G5 Charging Port Repair Melbourne | From $65',
  description:
    'LG G5 charging port repair in Melbourne starting From $65. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/lg-g5-charging-port-repair',
  },
  openGraph: {
    title: 'LG G5 Charging Port Repair Melbourne | From $65',
    description: 'LG G5 charging port repair Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/lg-g5-charging-port-repair',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'LG G5 Charging Port Repair Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
const relatedServices = [
  { name: 'Screen Replacement', href: '/lg-g5-screen-replacement' },
  { name: 'Battery Replacement', href: '/lg-g5-battery-replacement' },
  { name: 'Water Damage Repair', href: '/lg-g5-water-damage-repair' },
  { name: 'Free Diagnostic', href: '/lg-g5-free-device-inspection' },
]

export default function LgG5ChargingPortRepairPage() {
  return (
    <>
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-surface border-b border-gray-border py-3">
        <div className="container-page">
          <ol className="flex items-center gap-2 text-sm text-charcoal-light">
            ...
            <li aria-hidden="true">/</li>
            <li><Link href="/lg-g5-repair" className="hover:text-primary transition-colors">LG G5</Link></li>
            <li aria-hidden="true">/</li>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              LG G5 Charging Port Repair Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in LG G5 charging port repair using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your LG G5 Charging Port Repair Today
          </h2>
