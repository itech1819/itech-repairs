...
const location = locations.find((l) => l.id === 'braybrook')!

export const metadata: Metadata = {
  title: 'Phone Repair Braybrook | Walk In Today | iTech Repairs',
  description:
    'Phone repair shop in Braybrook VIC 3019. Walk in to 16 W Central Park Ave for iPhone, Samsung, iPad & MacBook repairs. On-the-spot repairs in around 15 minutes. No appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/braybrook-phone-repair',
  },
}
...
const services = [
  { label: 'iPhone Repairs', href: '/iphone-repair-braybrook' },
  { label: 'Samsung Repairs', href: '/samsung-repair-braybrook' },
  { label: 'iPad Repairs', href: '/ipad-repair-braybrook' },
  { label: 'MacBook Repairs', href: '/macbook-repair-braybrook' },
  { label: 'Google Pixel Repairs', href: '/pixel-repair-braybrook' },
]

export default function BraybrookStorePage() {
  return (
    <>
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-surface border-b border-gray-border py-3">
        <div className="container-page">
          <ol className="flex items-center gap-2 text-sm text-charcoal-light">
            ...
            <li className="text-charcoal font-medium">Braybrook Store</li>
          </ol>
        </div>
      </nav>
      ...
      <section className="bg-gradient-to-br from-charcoal to-charcoal-medium text-white py-14 md:py-20">
        <div className="container-page">
          <div className="max-w-2xl">
            ...
            <p className="text-xl text-gray-300 mb-2">16 W Central Park Ave, Braybrook VIC 3019</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div>
              <iframe
                ...
                title="iTech Repairs Braybrook Map"
              />
            </div>
      ...
      <section className="section-padding bg-gray-surface">
        <div className="container-page">
          <h2 className="text-2xl font-bold text-charcoal mb-2 text-center">Repairs at Braybrook</h2>
      ...
      <section className="section-padding">
        <div className="container-page">
          <div className="bg-charcoal text-white rounded-2xl p-10 text-center">
            <h2 className="text-2xl font-bold mb-3">Visit Our Braybrook Store Today</h2>
