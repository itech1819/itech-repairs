...
export const metadata: Metadata = {
  title: 'Oppo Reno 11 F Free Diagnostic Melbourne | Free',
  description:
    'Oppo Reno 11 F free diagnostic in Melbourne starting Free. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/oppo-reno-11-f-free-device-inspection',
  },
  openGraph: {
    title: 'Oppo Reno 11 F Free Diagnostic Melbourne | Free',
    description: 'Oppo Reno 11 F free diagnostic Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/oppo-reno-11-f-free-device-inspection',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Oppo Reno 11 F Free Diagnostic Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
export default function OppoReno11FFreeDeviceInspectionPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Oppo Reno 11 F Free Diagnostic Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Oppo Reno 11 F free diagnostic using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Oppo Reno 11 F Free Diagnostic Today
          </h2>
