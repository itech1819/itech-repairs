...
export const metadata: Metadata = {
  title: 'Moto G84 Repair Melbourne | Screen, Battery & More',
  description:
    'Moto G84 repair in Melbourne. Screen replacement, battery replacement, charging port repair, water damage repair and free diagnostic. Lifetime warranty. Walk in Braybrook or Spotswood.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/moto-g84-repair',
  },
  openGraph: {
    title: 'Moto G84 Repair Melbourne | Screen, Battery & More',
    description: 'Moto G84 repair in Melbourne. Lifetime warranty. Walk in today.',
    url: 'https://www.itechrepairs.com.au/moto-g84-repair',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Moto G84 Repair Melbourne',
  description: 'Expert Moto G84 repairs in Melbourne. Screen replacement, battery replacement, charging port repair, water damage repair and free diagnostics. Lifetime warranty.',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
...
const services = [
  { name: 'Screen Replacement', price: 'From $79', href: '/moto-g84-screen-replacement', serviceSlug: 'screen-replacement' },
  { name: 'Battery Replacement', price: 'From $69', href: '/moto-g84-battery-replacement', serviceSlug: 'battery-replacement' },
  { name: 'Charging Port Repair', price: 'From $59', href: '/moto-g84-charging-port-repair', serviceSlug: 'charging-port-repair' },
  { name: 'Water Damage Repair', price: 'From $79', href: '/moto-g84-water-damage-repair', serviceSlug: 'water-damage-repair' },
  { name: 'Free Diagnostic', price: 'Free', href: '/moto-g84-free-device-inspection', serviceSlug: 'free-device-inspection' },
]

export default function MotoG84RepairPage() {
  return (
    <>
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-surface border-b border-gray-border py-3">
        <div className="container-page">
          <ol className="flex items-center gap-2 text-sm text-charcoal-light">
            ...
            <li aria-hidden="true">/</li>
            <li className="text-charcoal font-medium">Moto G84</li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Moto G84 Repair Melbourne
            </h1>
            <p className="text-xl text-gray-300 mb-6">
              Screen Replacement · Battery Replacement · Charging Port · Lifetime Warranty
            </p>
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              Expert Moto G84 repairs in Melbourne. Walk in to our Braybrook or Spotswood store any time — no appointment needed. Every repair comes with a lifetime warranty on parts and labour.
            </p>
        ...
        <div className="container-page">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold text-charcoal mb-4">
              Moto G84 Repair Services
            </h2>
            <p className="text-charcoal-light text-lg">
              Select a repair to see pricing and availability for Moto G84 in Melbourne.
            </p>
          </div>
      ...
      <section className="bg-primary text-white py-16">
        <div className="container-page text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Need Your Moto G84 Repaired Today?
          </h2>
