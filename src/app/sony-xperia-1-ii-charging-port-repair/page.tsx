...
export const metadata: Metadata = {
  title: 'Sony Xperia 1 II Charging Port Repair Melbourne | From $69',
  description:
    'Sony Xperia 1 II charging port repair in Melbourne starting From $69. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/sony-xperia-1-ii-charging-port-repair',
  },
  openGraph: {
    title: 'Sony Xperia 1 II Charging Port Repair Melbourne | From $69',
    description: 'Sony Xperia 1 II charging port repair Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/sony-xperia-1-ii-charging-port-repair',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Sony Xperia 1 II Charging Port Repair Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
export default function SonyXperia1IiChargingPortRepairPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Sony Xperia 1 II Charging Port Repair Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Sony Xperia 1 II charging port repair using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Sony Xperia 1 II Charging Port Repair Today
          </h2>
