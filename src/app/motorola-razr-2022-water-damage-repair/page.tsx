...
export const metadata: Metadata = {
  title: 'Motorola Razr 2022 Water Damage Repair Melbourne | From $79',
  description:
    'Motorola Razr 2022 water damage repair in Melbourne starting From $79. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/motorola-razr-2022-water-damage-repair',
  },
  openGraph: {
    title: 'Motorola Razr 2022 Water Damage Repair Melbourne | From $79',
    description: 'Motorola Razr 2022 water damage repair Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/motorola-razr-2022-water-damage-repair',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Motorola Razr 2022 Water Damage Repair Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
export default function MotorolaRazr2022WaterDamageRepairPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Motorola Razr 2022 Water Damage Repair Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Motorola Razr 2022 water damage repair using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Motorola Razr 2022 Water Damage Repair Today
          </h2>
