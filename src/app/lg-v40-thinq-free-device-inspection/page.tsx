...
export const metadata: Metadata = {
  title: 'LG V40 ThinQ Free Diagnostic Melbourne | Free',
  description:
    'LG V40 ThinQ free diagnostic in Melbourne starting Free. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/lg-v40-thinq-free-device-inspection',
  },
  openGraph: {
    title: 'LG V40 ThinQ Free Diagnostic Melbourne | Free',
    description: 'LG V40 ThinQ free diagnostic Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/lg-v40-thinq-free-device-inspection',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'LG V40 ThinQ Free Diagnostic Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
export default function LgV40ThinqFreeDeviceInspectionPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              LG V40 ThinQ Free Diagnostic Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in LG V40 ThinQ free diagnostic using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your LG V40 ThinQ Free Diagnostic Today
          </h2>
