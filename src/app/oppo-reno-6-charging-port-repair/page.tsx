...
export const metadata: Metadata = {
  title: 'Oppo Reno 6 Charging Port Repair Melbourne | From $69',
  description:
    'Oppo Reno 6 charging port repair in Melbourne starting From $69. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/oppo-reno-6-charging-port-repair',
  },
  openGraph: {
    title: 'Oppo Reno 6 Charging Port Repair Melbourne | From $69',
    description: 'Oppo Reno 6 charging port repair Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/oppo-reno-6-charging-port-repair',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Oppo Reno 6 Charging Port Repair Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
const relatedServices = [
  { name: 'Screen Replacement', href: '/oppo-reno-6-screen-replacement' },
...
export default function OppoReno6ChargingPortRepairPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Oppo Reno 6 Charging Port Repair Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Oppo Reno 6 charging port repair using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Oppo Reno 6 Charging Port Repair Today
          </h2>
