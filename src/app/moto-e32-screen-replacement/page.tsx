...
export const metadata: Metadata = {
  title: 'Moto E32 Screen Replacement Melbourne | From $79',
  description:
    'Moto E32 screen replacement in Melbourne starting From $79. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/moto-e32-screen-replacement',
  },
  openGraph: {
    title: 'Moto E32 Screen Replacement Melbourne | From $79',
    description: 'Moto E32 screen replacement Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/moto-e32-screen-replacement',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Moto E32 Screen Replacement Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
const relatedServices = [
  { name: 'Battery Replacement', href: '/moto-e32-battery-replacement' },
  { name: 'Charging Port Repair', href: '/moto-e32-charging-port-repair' },
  { name: 'Water Damage Repair', href: '/moto-e32-water-damage-repair' },
  { name: 'Free Diagnostic', href: '/moto-e32-free-device-inspection' },
]

export default function MotoE32ScreenReplacementPage() {
  return (
    <>
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-surface border-b border-gray-border py-3">
        <div className="container-page">
          <ol className="flex items-center gap-2 text-sm text-charcoal-light">
            ...
            <li aria-hidden="true">/</li>
            <li><Link href="/moto-e32-repair" className="hover:text-primary transition-colors">Moto E32</Link></li>
            <li aria-hidden="true">/</li>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Moto E32 Screen Replacement Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Moto E32 screen replacement using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Moto E32 Screen Replacement Today
          </h2>
