...
export const metadata: Metadata = {
  title: 'Asus ROG Phone 7 Battery Replacement Melbourne | From $79',
  description:
    'Asus ROG Phone 7 battery replacement in Melbourne starting From $79. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/asus-rog-phone-7-battery-replacement',
  },
  openGraph: {
    title: 'Asus ROG Phone 7 Battery Replacement Melbourne | From $79',
    description: 'Asus ROG Phone 7 battery replacement Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/asus-rog-phone-7-battery-replacement',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Asus ROG Phone 7 Battery Replacement Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
export default function AsusRogPhone7BatteryReplacementPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Asus ROG Phone 7 Battery Replacement Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Asus ROG Phone 7 battery replacement using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Asus ROG Phone 7 Battery Replacement Today
          </h2>
