...
export const metadata: Metadata = {
  title: 'Nokia 8.3 5G Screen Replacement Melbourne | From $69',
  description:
    'Nokia 8.3 5G screen replacement in Melbourne starting From $69. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/nokia-8-3-5g-screen-replacement',
  },
  openGraph: {
    title: 'Nokia 8.3 5G Screen Replacement Melbourne | From $69',
    description: 'Nokia 8.3 5G screen replacement Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/nokia-8-3-5g-screen-replacement',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Nokia 8.3 5G Screen Replacement Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
const relatedServices = [
  ...
  { name: 'Charging Port Repair', href: '/nokia-8-3-5g-charging-port-repair' },
...
export default function Nokia835gScreenReplacementPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Nokia 8.3 5G Screen Replacement Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Nokia 8.3 5G screen replacement using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Nokia 8.3 5G Screen Replacement Today
          </h2>
