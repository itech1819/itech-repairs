...
export const metadata: Metadata = {
  title: 'Oppo A58 Screen Replacement Melbourne | From $89',
  description:
    'Oppo A58 screen replacement in Melbourne. From $89. Lifetime warranty on parts and labour. Walk in Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/oppo-a58-screen-replacement',
  },
  openGraph: {
    title: 'Oppo A58 Screen Replacement Melbourne | From $89',
    description: 'Oppo A58 screen replacement in Melbourne. From $89. Lifetime warranty. Walk in today.',
    url: 'https://www.itechrepairs.com.au/oppo-a58-screen-replacement',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Oppo A58 Screen Replacement Melbourne',
  description: 'Professional Oppo A58 screen replacement in Melbourne. Lifetime warranty on parts and labour. Walk in Braybrook or Spotswood.',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
...
const relatedServices = [
      { name: 'Battery Replacement', href: '/oppo-a58-battery-replacement', price: 'From $79' },
      { name: 'Charging Port Repair', href: '/oppo-a58-charging-port-repair', price: 'From $69' },
      { name: 'Water Damage Repair', href: '/oppo-a58-water-damage-repair', price: 'From $89' },
      { name: 'Free Diagnostic', href: '/oppo-a58-free-device-inspection', price: 'Free' },
]

export default function OppoA58ScreenReplacementPage() {
  return (
    <>
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-surface border-b border-gray-border py-3">
        <div className="container-page">
          <ol className="flex items-center gap-2 text-sm text-charcoal-light">
            ...
            <li aria-hidden="true">/</li>
            <li><Link href="/oppo-a58-repair" className="hover:text-primary transition-colors">Oppo A58</Link></li>
            <li aria-hidden="true">/</li>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Oppo A58 Screen Replacement Melbourne
            </h1>
            <p className="text-xl text-gray-300 mb-6">
              From $89 · Lifetime Warranty · Same Day · Walk In Welcome
            </p>
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              Expert Oppo A58 screen replacement in Melbourne. Walk in to our Braybrook or Spotswood store — no appointment needed. Every repair includes a lifetime warranty on parts and labour.
            </p>
        ...
        <div className="container-page">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-charcoal mb-4">
              Oppo A58 Screen Replacement in Melbourne
            </h2>
            <p className="text-charcoal-light leading-relaxed mb-4">
              Our technicians specialise in Oppo A58 repairs in Melbourne. We use quality replacement parts and follow precise repair procedures so your device works exactly as intended after service.
            </p>
      ...
      <section className="bg-primary text-white py-16">
        <div className="container-page text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Book Your Oppo A58 Screen Replacement Today
          </h2>
