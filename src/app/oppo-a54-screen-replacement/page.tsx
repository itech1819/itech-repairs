...
export const metadata: Metadata = {
  title: 'Oppo A54 Screen Replacement Melbourne | From $89',
  description:
    'Oppo A54 screen replacement in Melbourne starting From $89. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/oppo-a54-screen-replacement',
  },
  openGraph: {
    title: 'Oppo A54 Screen Replacement Melbourne | From $89',
    description: 'Oppo A54 screen replacement Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/oppo-a54-screen-replacement',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Oppo A54 Screen Replacement Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
const relatedServices = [
  { name: 'Battery Replacement', href: '/oppo-a54-battery-replacement' },
  { name: 'Charging Port Repair', href: '/oppo-a54-charging-port-repair' },
  { name: 'Water Damage Repair', href: '/oppo-a54-water-damage-repair' },
  { name: 'Free Diagnostic', href: '/oppo-a54-free-device-inspection' },
]

export default function OppoA54ScreenReplacementPage() {
  return (
    <>
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-surface border-b border-gray-border py-3">
        <div className="container-page">
          <ol className="flex items-center gap-2 text-sm text-charcoal-light">
            ...
            <li aria-hidden="true">/</li>
            <li><Link href="/oppo-a54-repair" className="hover:text-primary transition-colors">Oppo A54</Link></li>
            <li aria-hidden="true">/</li>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Oppo A54 Screen Replacement Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Oppo A54 screen replacement using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Oppo A54 Screen Replacement Today
          </h2>
