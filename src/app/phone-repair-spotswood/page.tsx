...
export const metadata: Metadata = {
  title: 'Phone Repair Spotswood | iPhone & Samsung — Walk In Today',
  description:
    'Phone repair near Spotswood — iTech Repairs Spotswood store is right here. iPhone, Samsung, iPad & MacBook repair from $79. Cheapest prices guaranteed. Walk in today.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/phone-repair-spotswood',
  },
  openGraph: {
    title: 'Phone Repair Spotswood | iPhone & Samsung — Walk In Today',
    description: 'Phone repair near Spotswood — iTech Repairs Spotswood store is right here. iPhone, Samsung, iPad & MacBook repair from $79. Cheapest prices guaranteed. Walk in today.',
    url: 'https://www.itechrepairs.com.au/phone-repair-spotswood',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Phone Repair Spotswood',
  description:
    'Phone repair in Spotswood at iTech Repairs. iPhone, Samsung, iPad and MacBook repair with lifetime warranty and cheapest price guaranteed.',
  provider: {
    '@type': 'RepairShop',
    name: business.name,
...
const faqs = [
  {
    question: 'Is there a phone repair shop in Spotswood?',
    answer: 'Yes — iTech Repairs has a store in Spotswood. Walk in any day between 9am and 9pm for same-day iPhone, Samsung, iPad and MacBook repair.',
    category: 'general' as const,
  },
  {
    question: 'How much does phone repair cost in Spotswood?',
    answer: 'Screen repair starts from $79 and battery replacement from $79 at our Spotswood store. We provide a firm quote before any work begins.',
    category: 'general' as const,
  },
  {
    question: 'What phone repairs are available in Spotswood?',
  ...
  {
    question: 'Do I need an appointment for phone repair in Spotswood?',
    answer: 'No appointment needed. Walk in to our Spotswood store any day 9am–9pm and we will assess your device and start your repair immediately.',
    category: 'general' as const,
  },
]
...
export default function PhoneRepairSpotswoodPage() {
  return (
    <>
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-surface border-b border-gray-border py-3">
        <div className="container-page">
          <ol className="flex items-center gap-2 text-sm text-charcoal-light">
            ...
            <li className="text-charcoal font-medium">Phone Repair Spotswood</li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 mb-6">
              From $79 · Spotswood Store · Same Day · Lifetime Warranty
            </p>
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              Need phone repair in Spotswood? iTech Repairs has a store right in Spotswood. Walk in any day for same-day iPhone, Samsung, iPad and MacBook repair with the cheapest prices guaranteed and a lifetime warranty on every repair. No appointment needed.
            </p>
        ...
        <div className="container-page">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
            {[
              ...
              { label: 'In Spotswood', sub: 'Local Store' },
        ...
        <div className="container-page">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-charcoal mb-6">
              Your Local Phone Repair Shop in Spotswood
            </h2>
            <p className="text-charcoal-light text-lg mb-6 leading-relaxed">
              iTech Repairs Spotswood is your local phone repair specialist. Whether you have a cracked iPhone screen, a Samsung that won&apos;t charge, or an iPad with a broken display — we fix it fast, with quality parts and a lifetime warranty.
            </p>
            <p className="text-charcoal-light text-lg mb-8 leading-relaxed">
              Walk in any day without an appointment. We serve Spotswood residents and surrounding suburbs including Yarraville, Newport, Williamstown, Altona and all of Melbourne&apos;s west.
            </p>
      ...
      <section className="section-padding">
        <div className="container-page">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            ...
            <Link href="/phone-repair-braybrook" className="px-4 py-2 bg-white hover:bg-primary hover:text-white border border-gray-border rounded-full text-sm font-medium text-charcoal transition-colors">
      ...
      <section className="bg-primary text-white py-16">
        <div className="container-page text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Spotswood Phone Repair — Walk In Today
          </h2>
          <p className="text-lg text-red-100 mb-8 max-w-xl mx-auto">
            No appointment needed. Same-day repairs from $79 with lifetime warranty. Open 7 days 9am–9pm in Spotswood.
          </p>
