...
export const metadata: Metadata = {
  title: 'Realme Narzo 70 Charging Port Repair Melbourne | From $59',
  description:
    'Realme Narzo 70 charging port repair in Melbourne. From $59. Lifetime warranty on parts and labour. Walk in Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/realme-narzo-70-charging-port-repair',
  },
  openGraph: {
    title: 'Realme Narzo 70 Charging Port Repair Melbourne | From $59',
    description: 'Realme Narzo 70 charging port repair in Melbourne. From $59. Lifetime warranty. Walk in today.',
    url: 'https://www.itechrepairs.com.au/realme-narzo-70-charging-port-repair',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Realme Narzo 70 Charging Port Repair Melbourne',
  description: 'Professional Realme Narzo 70 charging port repair in Melbourne. Lifetime warranty on parts and labour. Walk in Braybrook or Spotswood.',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
...
const relatedServices = [
      { name: 'Screen Replacement', href: '/realme-narzo-70-screen-replacement', price: 'From $79' },
      { name: 'Battery Replacement', href: '/realme-narzo-70-battery-replacement', price: 'From $69' },
      { name: 'Water Damage Repair', href: '/realme-narzo-70-water-damage-repair', price: 'From $79' },
      { name: 'Free Diagnostic', href: '/realme-narzo-70-free-device-inspection', price: 'Free' },
]

export default function RealmeNarzo70ChargingPortRepairPage() {
  return (
    <>
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-surface border-b border-gray-border py-3">
        <div className="container-page">
          <ol className="flex items-center gap-2 text-sm text-charcoal-light">
            ...
            <li aria-hidden="true">/</li>
            <li><Link href="/realme-narzo-70-repair" className="hover:text-primary transition-colors">Realme Narzo 70</Link></li>
            <li aria-hidden="true">/</li>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Realme Narzo 70 Charging Port Repair Melbourne
            </h1>
            <p className="text-xl text-gray-300 mb-6">
              From $59 · Lifetime Warranty · Same Day · Walk In Welcome
            </p>
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              Expert Realme Narzo 70 charging port repair in Melbourne. Walk in to our Braybrook or Spotswood store — no appointment needed. Every repair includes a lifetime warranty on parts and labour.
            </p>
        ...
        <div className="container-page">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-charcoal mb-4">
              Realme Narzo 70 Charging Port Repair in Melbourne
            </h2>
            <p className="text-charcoal-light leading-relaxed mb-4">
              Our technicians specialise in Realme Narzo 70 repairs in Melbourne. We use quality replacement parts and follow precise repair procedures so your device works exactly as intended after service.
            </p>
      ...
      <section className="bg-primary text-white py-16">
        <div className="container-page text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Book Your Realme Narzo 70 Charging Port Repair Today
          </h2>
