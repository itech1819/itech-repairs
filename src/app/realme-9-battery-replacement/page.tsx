...
export const metadata: Metadata = {
  title: 'Realme 9 Battery Replacement Melbourne | From $69',
  description:
    'Realme 9 battery replacement in Melbourne starting From $69. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/realme-9-battery-replacement',
  },
  openGraph: {
    title: 'Realme 9 Battery Replacement Melbourne | From $69',
    description: 'Realme 9 battery replacement Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/realme-9-battery-replacement',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Realme 9 Battery Replacement Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
export default function Realme9BatteryReplacementPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Realme 9 Battery Replacement Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Realme 9 battery replacement using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Realme 9 Battery Replacement Today
          </h2>
