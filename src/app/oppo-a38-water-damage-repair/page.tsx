...
export const metadata: Metadata = {
  title: 'Oppo A38 Water Damage Repair Melbourne | From $89',
  description:
    'Oppo A38 water damage repair in Melbourne. From $89. Lifetime warranty on parts and labour. Walk in Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/oppo-a38-water-damage-repair',
  },
  openGraph: {
    title: 'Oppo A38 Water Damage Repair Melbourne | From $89',
    description: 'Oppo A38 water damage repair in Melbourne. From $89. Lifetime warranty. Walk in today.',
    url: 'https://www.itechrepairs.com.au/oppo-a38-water-damage-repair',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Oppo A38 Water Damage Repair Melbourne',
  description: 'Professional Oppo A38 water damage repair in Melbourne. Lifetime warranty on parts and labour. Walk in Braybrook or Spotswood.',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
...
export default function OppoA38WaterDamageRepairPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Oppo A38 Water Damage Repair Melbourne
            </h1>
            <p className="text-xl text-gray-300 mb-6">
              From $89 · Lifetime Warranty · Same Day · Walk In Welcome
            </p>
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              Expert Oppo A38 water damage repair in Melbourne. Walk in to our Braybrook or Spotswood store — no appointment needed. Every repair includes a lifetime warranty on parts and labour.
            </p>
        ...
        <div className="container-page">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-charcoal mb-4">
              Oppo A38 Water Damage Repair in Melbourne
            </h2>
      ...
      <section className="bg-primary text-white py-16">
        <div className="container-page text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Book Your Oppo A38 Water Damage Repair Today
          </h2>
