...
export const metadata: Metadata = {
  title: 'Asus ZenFone 8 Free Diagnostic Melbourne | Free',
  description:
    'Asus ZenFone 8 free diagnostic in Melbourne starting Free. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/asus-zenfone-8-free-device-inspection',
  },
  openGraph: {
    title: 'Asus ZenFone 8 Free Diagnostic Melbourne | Free',
    description: 'Asus ZenFone 8 free diagnostic Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/asus-zenfone-8-free-device-inspection',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Asus ZenFone 8 Free Diagnostic Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
export default function AsusZenfone8FreeDeviceInspectionPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Asus ZenFone 8 Free Diagnostic Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Asus ZenFone 8 free diagnostic using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Asus ZenFone 8 Free Diagnostic Today
          </h2>
