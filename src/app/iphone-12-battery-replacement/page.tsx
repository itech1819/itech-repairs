...
export const metadata: Metadata = {
  title: 'iPhone 12 Battery Replacement Melbourne | From $89',
  description:
    'iPhone 12 battery replacement in Melbourne from $89. Same-day service at Braybrook & Spotswood. Lifetime warranty on parts and labour. Walk in today.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/iphone-12-battery-replacement',
  },
  openGraph: {
    title: 'iPhone 12 Battery Replacement Melbourne | From $89',
    description: 'iPhone 12 battery replacement in Melbourne from $89. Same-day service at Braybrook & Spotswood. Lifetime warranty on parts and labour. Walk in today.',
    url: 'https://www.itechrepairs.com.au/iphone-12-battery-replacement',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'iPhone 12 Battery Replacement Melbourne',
  description:
    'iPhone 12 battery replacement in Melbourne from $89. Same-day service at Braybrook & Spotswood. Lifetime warranty on parts and labour.',
  provider: {
    '@type': 'RepairShop',
    name: business.name,
...
const faqs = [
  {
    question: 'How much does iPhone 12 battery replacement cost?',
    answer: 'iPhone 12 battery replacement starts from $89. We provide a firm quote before starting any work.',
    category: 'general' as const,
  },
  {
    question: 'How long does iPhone 12 battery replacement take?',
    answer: 'Most iPhone 12 battery replacements are completed in 15–20 minutes at our Braybrook or Spotswood store.',
    category: 'general' as const,
  },
  {
    question: 'Will my Face ID still work after battery replacement?',
    answer: 'Yes. Battery replacement does not affect Face ID or any other features.',
    category: 'general' as const,
  },
  {
    question: 'Do you use genuine Apple batteries?',
    answer: 'We use high-quality replacement batteries that meet or exceed original Apple specifications.',
    category: 'general' as const,
  },
]
...
export default function Iphone12BatteryReplacementPage() {
  return (
    <>
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-surface border-b border-gray-border py-3">
        <div className="container-page">
          <ol className="flex items-center gap-2 text-sm text-charcoal-light">
            ...
            <li aria-hidden="true">/</li>
            <li className="text-charcoal font-medium">iPhone 12 Battery Replacement</li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              iPhone 12 Battery Replacement Melbourne
            </h1>
            <p className="text-xl text-gray-300 mb-6">
              From $89 · 15–20 Minutes · Same Day · Lifetime Warranty
            </p>
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              iPhone 12 battery draining too fast or shutting down unexpectedly? Walk in to our Braybrook or Spotswood store for a fast iPhone 12 battery replacement with lifetime warranty. Done in 15–20 minutes with no hidden fees.
            </p>
        ...
        <div className="container-page">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-charcoal mb-8 text-center">
              Why Choose iTech Repairs for iPhone 12 Battery?
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                { title: 'Fast 15-Minute Service', body: 'iPhone 12 battery replacements completed in 15–20 minutes while you wait in-store.' },
                { title: 'Lifetime Warranty', body: 'Every battery replacement includes a lifetime warranty on parts and labour.' },
                { title: 'Face ID Unaffected', body: 'Battery replacement does not affect Face ID or any other iPhone 12 features.' },
                { title: 'Data Stays Intact', body: 'Battery replacement does not require wiping your device. All your data remains safe.' },
        ...
        <div className="container-page">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold text-charcoal mb-4">
              iPhone 12 Battery Replacement FAQ
            </h2>
          </div>
      ...
      <section className="bg-primary text-white py-16">
        <div className="container-page text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            iPhone 12 Battery Draining Fast? Fix It Today.
          </h2>
          <p className="text-lg text-red-100 mb-8 max-w-xl mx-auto">
            Walk in to our Braybrook or Spotswood store — no appointment needed. iPhone 12 battery replacement from $89 with a lifetime warranty.
          </p>
