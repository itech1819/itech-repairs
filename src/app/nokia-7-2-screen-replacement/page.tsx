...
export const metadata: Metadata = {
  title: 'Nokia 7.2 Screen Replacement Melbourne | From $69',
  description:
    'Nokia 7.2 screen replacement in Melbourne starting From $69. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/nokia-7-2-screen-replacement',
  },
  openGraph: {
    title: 'Nokia 7.2 Screen Replacement Melbourne | From $69',
    description: 'Nokia 7.2 screen replacement Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/nokia-7-2-screen-replacement',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Nokia 7.2 Screen Replacement Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
const relatedServices = [
  { name: 'Battery Replacement', href: '/nokia-7-2-battery-replacement' },
  { name: 'Charging Port Repair', href: '/nokia-7-2-charging-port-repair' },
  { name: 'Water Damage Repair', href: '/nokia-7-2-water-damage-repair' },
  { name: 'Free Diagnostic', href: '/nokia-7-2-free-device-inspection' },
]

export default function Nokia72ScreenReplacementPage() {
  return (
    <>
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-surface border-b border-gray-border py-3">
        <div className="container-page">
          <ol className="flex items-center gap-2 text-sm text-charcoal-light">
            ...
            <li aria-hidden="true">/</li>
            <li><Link href="/nokia-7-2-repair" className="hover:text-primary transition-colors">Nokia 7.2</Link></li>
            <li aria-hidden="true">/</li>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Nokia 7.2 Screen Replacement Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Nokia 7.2 screen replacement using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Nokia 7.2 Screen Replacement Today
          </h2>
