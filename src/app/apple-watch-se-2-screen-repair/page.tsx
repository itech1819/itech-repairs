...
export const metadata: Metadata = {
  title: 'Apple Watch SE 2 Screen Repair Melbourne | From $149',
  description:
    'Apple Watch SE 2 screen repair in Melbourne. From $149. Lifetime warranty on parts and labour. Walk in Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/apple-watch-se-2-screen-repair',
  },
  openGraph: {
    title: 'Apple Watch SE 2 Screen Repair Melbourne | From $149',
    description: 'Apple Watch SE 2 screen repair in Melbourne. From $149. Lifetime warranty. Walk in today.',
    url: 'https://www.itechrepairs.com.au/apple-watch-se-2-screen-repair',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Apple Watch SE 2 Screen Repair Melbourne',
  description: 'Professional Apple Watch SE 2 screen repair in Melbourne. Lifetime warranty on parts and labour. Walk in Braybrook or Spotswood.',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
...
export default function AppleWatchSe2ScreenRepairPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Apple Watch SE 2 Screen Repair Melbourne
            </h1>
            <p className="text-xl text-gray-300 mb-6">
              From $149 · Lifetime Warranty · Same Day · Walk In Welcome
            </p>
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              Expert Apple Watch SE 2 screen repair in Melbourne. Walk in to our Braybrook or Spotswood store — no appointment needed. Every repair comes with a lifetime warranty on parts and labour.
            </p>
        ...
        <div className="container-page">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-charcoal-light leading-relaxed">
              Every Apple Watch SE 2 screen repair at iTech Repairs comes with a lifetime warranty on both parts and labour. If the same fault returns, we fix it at no extra cost.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-primary text-white py-16">
        <div className="container-page text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Book Your Apple Watch SE 2 Screen Repair Today
          </h2>
