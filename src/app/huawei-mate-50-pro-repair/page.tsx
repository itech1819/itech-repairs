...
export const metadata: Metadata = {
  title: 'Huawei Mate 50 Pro Repair Melbourne | Screen, Battery & More',
  description:
    'Huawei Mate 50 Pro repair in Melbourne. Screen replacement, battery replacement, charging port repair, water damage repair and free diagnostic. Lifetime warranty. Walk in Braybrook or Spotswood.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/huawei-mate-50-pro-repair',
  },
  openGraph: {
    title: 'Huawei Mate 50 Pro Repair Melbourne | Screen, Battery & More',
    description: 'Huawei Mate 50 Pro repair in Melbourne. Lifetime warranty. Walk in today.',
    url: 'https://www.itechrepairs.com.au/huawei-mate-50-pro-repair',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Huawei Mate 50 Pro Repair Melbourne',
  description: 'Expert Huawei Mate 50 Pro repairs in Melbourne. Screen replacement, battery replacement, charging port repair, water damage repair and free diagnostics. Lifetime warranty.',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
...
const services = [
  { name: 'Screen Replacement', price: 'From $89', href: '/huawei-mate-50-pro-screen-replacement', serviceSlug: 'screen-replacement' },
  { name: 'Battery Replacement', price: 'From $79', href: '/huawei-mate-50-pro-battery-replacement', serviceSlug: 'battery-replacement' },
  { name: 'Charging Port Repair', price: 'From $69', href: '/huawei-mate-50-pro-charging-port-repair', serviceSlug: 'charging-port-repair' },
  { name: 'Water Damage Repair', price: 'From $89', href: '/huawei-mate-50-pro-water-damage-repair', serviceSlug: 'water-damage-repair' },
  { name: 'Free Diagnostic', price: 'Free', href: '/huawei-mate-50-pro-free-device-inspection', serviceSlug: 'free-device-inspection' },
]

export default function HuaweiMate50ProRepairPage() {
  return (
    <>
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-surface border-b border-gray-border py-3">
        <div className="container-page">
          <ol className="flex items-center gap-2 text-sm text-charcoal-light">
            ...
            <li aria-hidden="true">/</li>
            <li className="text-charcoal font-medium">Huawei Mate 50 Pro</li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Huawei Mate 50 Pro Repair Melbourne
            </h1>
            <p className="text-xl text-gray-300 mb-6">
              Screen Replacement · Battery Replacement · Charging Port · Lifetime Warranty
            </p>
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              Expert Huawei Mate 50 Pro repairs in Melbourne. Walk in to our Braybrook or Spotswood store any time — no appointment needed. Every repair comes with a lifetime warranty on parts and labour.
            </p>
        ...
        <div className="container-page">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold text-charcoal mb-4">
              Huawei Mate 50 Pro Repair Services
            </h2>
            <p className="text-charcoal-light text-lg">
              Select a repair to see pricing and availability for Huawei Mate 50 Pro in Melbourne.
            </p>
          </div>
      ...
      <section className="bg-primary text-white py-16">
        <div className="container-page text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Need Your Huawei Mate 50 Pro Repaired Today?
          </h2>
