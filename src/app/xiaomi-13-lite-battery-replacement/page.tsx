...
export const metadata: Metadata = {
  title: 'Xiaomi 13 Lite Battery Replacement Melbourne | From $69',
  description:
    'Xiaomi 13 Lite battery replacement in Melbourne starting From $69. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/xiaomi-13-lite-battery-replacement',
  },
  openGraph: {
    title: 'Xiaomi 13 Lite Battery Replacement Melbourne | From $69',
    description: 'Xiaomi 13 Lite battery replacement Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/xiaomi-13-lite-battery-replacement',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Xiaomi 13 Lite Battery Replacement Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
export default function Xiaomi13LiteBatteryReplacementPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Xiaomi 13 Lite Battery Replacement Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Xiaomi 13 Lite battery replacement using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Xiaomi 13 Lite Battery Replacement Today
          </h2>
