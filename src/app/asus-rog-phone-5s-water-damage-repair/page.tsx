...
export const metadata: Metadata = {
  title: 'Asus ROG Phone 5s Water Damage Repair Melbourne | From $99',
  description:
    'Asus ROG Phone 5s water damage repair in Melbourne starting From $99. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/asus-rog-phone-5s-water-damage-repair',
  },
  openGraph: {
    title: 'Asus ROG Phone 5s Water Damage Repair Melbourne | From $99',
    description: 'Asus ROG Phone 5s water damage repair Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/asus-rog-phone-5s-water-damage-repair',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Asus ROG Phone 5s Water Damage Repair Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
export default function AsusRogPhone5sWaterDamageRepairPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Asus ROG Phone 5s Water Damage Repair Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Asus ROG Phone 5s water damage repair using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Asus ROG Phone 5s Water Damage Repair Today
          </h2>
