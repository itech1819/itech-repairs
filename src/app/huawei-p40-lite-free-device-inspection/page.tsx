...
export const metadata: Metadata = {
  title: 'Huawei P40 Lite Free Diagnostic Melbourne | Free',
  description:
    'Huawei P40 Lite free diagnostic in Melbourne starting Free. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/huawei-p40-lite-free-device-inspection',
  },
  openGraph: {
    title: 'Huawei P40 Lite Free Diagnostic Melbourne | Free',
    description: 'Huawei P40 Lite free diagnostic Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/huawei-p40-lite-free-device-inspection',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Huawei P40 Lite Free Diagnostic Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
export default function HuaweiP40LiteFreeDeviceInspectionPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Huawei P40 Lite Free Diagnostic Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Huawei P40 Lite free diagnostic using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Huawei P40 Lite Free Diagnostic Today
          </h2>
