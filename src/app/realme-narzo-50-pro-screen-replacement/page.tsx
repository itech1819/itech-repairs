...
export const metadata: Metadata = {
  title: 'Realme Narzo 50 Pro Screen Replacement Melbourne | From $79',
  description:
    'Realme Narzo 50 Pro screen replacement in Melbourne starting From $79. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/realme-narzo-50-pro-screen-replacement',
  },
  openGraph: {
    title: 'Realme Narzo 50 Pro Screen Replacement Melbourne | From $79',
    description: 'Realme Narzo 50 Pro screen replacement Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/realme-narzo-50-pro-screen-replacement',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Realme Narzo 50 Pro Screen Replacement Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
const relatedServices = [
  ...
  { name: 'Charging Port Repair', href: '/realme-narzo-50-pro-charging-port-repair' },
...
export default function RealmeNarzo50ProScreenReplacementPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Realme Narzo 50 Pro Screen Replacement Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Realme Narzo 50 Pro screen replacement using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Realme Narzo 50 Pro Screen Replacement Today
          </h2>
