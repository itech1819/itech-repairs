...
export const metadata: Metadata = {
  title: 'Realme 9 Pro+ Charging Port Repair Melbourne | From $59',
  description:
    'Realme 9 Pro+ charging port repair in Melbourne starting From $59. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/realme-9-pro-charging-port-repair',
  },
  openGraph: {
    title: 'Realme 9 Pro+ Charging Port Repair Melbourne | From $59',
    description: 'Realme 9 Pro+ charging port repair Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/realme-9-pro-charging-port-repair',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Realme 9 Pro+ Charging Port Repair Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
const relatedServices = [
  { name: 'Screen Replacement', href: '/realme-9-pro-screen-replacement' },
...
export default function Realme9ProChargingPortRepairPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Realme 9 Pro+ Charging Port Repair Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Realme 9 Pro+ charging port repair using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Realme 9 Pro+ Charging Port Repair Today
          </h2>
