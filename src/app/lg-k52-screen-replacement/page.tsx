...
export const metadata: Metadata = {
  title: 'LG K52 Screen Replacement Melbourne | From $79',
  description:
    'LG K52 screen replacement in Melbourne. From $79. Lifetime warranty on parts and labour. Walk in Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/lg-k52-screen-replacement',
  },
  openGraph: {
    title: 'LG K52 Screen Replacement Melbourne | From $79',
    description: 'LG K52 screen replacement in Melbourne. From $79. Lifetime warranty. Walk in today.',
    url: 'https://www.itechrepairs.com.au/lg-k52-screen-replacement',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'LG K52 Screen Replacement Melbourne',
  description: 'Professional LG K52 screen replacement in Melbourne. Lifetime warranty on parts and labour. Walk in Braybrook or Spotswood.',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
...
const relatedServices = [
      { name: 'Battery Replacement', href: '/lg-k52-battery-replacement', price: 'From $69' },
      { name: 'Charging Port Repair', href: '/lg-k52-charging-port-repair', price: 'From $65' },
      { name: 'Water Damage Repair', href: '/lg-k52-water-damage-repair', price: 'From $79' },
      { name: 'Free Diagnostic', href: '/lg-k52-free-device-inspection', price: 'Free' },
]

export default function LgK52ScreenReplacementPage() {
  return (
    <>
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-surface border-b border-gray-border py-3">
        <div className="container-page">
          <ol className="flex items-center gap-2 text-sm text-charcoal-light">
            ...
            <li aria-hidden="true">/</li>
            <li><Link href="/lg-k52-repair" className="hover:text-primary transition-colors">LG K52</Link></li>
            <li aria-hidden="true">/</li>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              LG K52 Screen Replacement Melbourne
            </h1>
            <p className="text-xl text-gray-300 mb-6">
              From $79 · Lifetime Warranty · Same Day · Walk In Welcome
            </p>
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              Expert LG K52 screen replacement in Melbourne. Walk in to our Braybrook or Spotswood store — no appointment needed. Every repair includes a lifetime warranty on parts and labour.
            </p>
        ...
        <div className="container-page">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-charcoal mb-4">
              LG K52 Screen Replacement in Melbourne
            </h2>
            <p className="text-charcoal-light leading-relaxed mb-4">
              Our technicians specialise in LG K52 repairs in Melbourne. We use quality replacement parts and follow precise repair procedures so your device works exactly as intended after service.
            </p>
      ...
      <section className="bg-primary text-white py-16">
        <div className="container-page text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Book Your LG K52 Screen Replacement Today
          </h2>
