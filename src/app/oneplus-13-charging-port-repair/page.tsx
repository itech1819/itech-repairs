...
export const metadata: Metadata = {
  title: 'OnePlus 13 Charging Port Repair Melbourne | From $69',
  description:
    'OnePlus 13 charging port repair in Melbourne. From $69. Lifetime warranty on parts and labour. Walk in Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/oneplus-13-charging-port-repair',
  },
  openGraph: {
    title: 'OnePlus 13 Charging Port Repair Melbourne | From $69',
    description: 'OnePlus 13 charging port repair in Melbourne. From $69. Lifetime warranty. Walk in today.',
    url: 'https://www.itechrepairs.com.au/oneplus-13-charging-port-repair',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'OnePlus 13 Charging Port Repair Melbourne',
  description: 'Professional OnePlus 13 charging port repair in Melbourne. Lifetime warranty on parts and labour. Walk in Braybrook or Spotswood.',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
...
const relatedServices = [
      { name: 'Screen Replacement', href: '/oneplus-13-screen-replacement', price: 'From $89' },
...
export default function Oneplus13ChargingPortRepairPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              OnePlus 13 Charging Port Repair Melbourne
            </h1>
            <p className="text-xl text-gray-300 mb-6">
              From $69 · Lifetime Warranty · Same Day · Walk In Welcome
            </p>
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              Expert OnePlus 13 charging port repair in Melbourne. Walk in to our Braybrook or Spotswood store — no appointment needed. Every repair includes a lifetime warranty on parts and labour.
            </p>
        ...
        <div className="container-page">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-charcoal mb-4">
              OnePlus 13 Charging Port Repair in Melbourne
            </h2>
      ...
      <section className="bg-primary text-white py-16">
        <div className="container-page text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Book Your OnePlus 13 Charging Port Repair Today
          </h2>
