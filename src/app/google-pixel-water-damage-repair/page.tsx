...
const page = BRAND_SERVICE_BY_SLUG.get('google-pixel-water-damage-repair')!

export const metadata: Metadata = {
  title: page.metaTitle,
  description: page.metaDescription,
  alternates: { canonical: 'https://www.itechrepairs.com.au/google-pixel-water-damage-repair' },
  robots: 'index, follow',
}
