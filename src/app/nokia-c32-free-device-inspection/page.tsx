...
export const metadata: Metadata = {
  title: 'Nokia C32 Free Diagnostic Melbourne | Free',
  description:
    'Nokia C32 free diagnostic in Melbourne. Free. Lifetime warranty on parts and labour. Walk in Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/nokia-c32-free-device-inspection',
  },
  openGraph: {
    title: 'Nokia C32 Free Diagnostic Melbourne | Free',
    description: 'Nokia C32 free diagnostic in Melbourne. Free. Lifetime warranty. Walk in today.',
    url: 'https://www.itechrepairs.com.au/nokia-c32-free-device-inspection',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Nokia C32 Free Diagnostic Melbourne',
  description: 'Professional Nokia C32 free diagnostic in Melbourne. Lifetime warranty on parts and labour. Walk in Braybrook or Spotswood.',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
...
export default function NokiaC32FreeDeviceInspectionPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Nokia C32 Free Diagnostic Melbourne
            </h1>
            <p className="text-xl text-gray-300 mb-6">
              Free · Lifetime Warranty · Same Day · Walk In Welcome
            </p>
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              Expert Nokia C32 free diagnostic in Melbourne. Walk in to our Braybrook or Spotswood store — no appointment needed. Every repair includes a lifetime warranty on parts and labour.
            </p>
        ...
        <div className="container-page">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-charcoal mb-4">
              Nokia C32 Free Diagnostic in Melbourne
            </h2>
      ...
      <section className="bg-primary text-white py-16">
        <div className="container-page text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Book Your Nokia C32 Free Diagnostic Today
          </h2>
