...
export const metadata: Metadata = {
  title: 'Redmi 10C Screen Replacement Melbourne | From $79',
  description:
    'Redmi 10C screen replacement in Melbourne starting From $79. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/redmi-10c-screen-replacement',
  },
  openGraph: {
    title: 'Redmi 10C Screen Replacement Melbourne | From $79',
    description: 'Redmi 10C screen replacement Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/redmi-10c-screen-replacement',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Redmi 10C Screen Replacement Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
const relatedServices = [
  { name: 'Battery Replacement', href: '/redmi-10c-battery-replacement' },
  { name: 'Charging Port Repair', href: '/redmi-10c-charging-port-repair' },
  { name: 'Water Damage Repair', href: '/redmi-10c-water-damage-repair' },
  { name: 'Free Diagnostic', href: '/redmi-10c-free-device-inspection' },
]

export default function Redmi10cScreenReplacementPage() {
  return (
    <>
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-surface border-b border-gray-border py-3">
        <div className="container-page">
          <ol className="flex items-center gap-2 text-sm text-charcoal-light">
            ...
            <li aria-hidden="true">/</li>
            <li><Link href="/redmi-10c-repair" className="hover:text-primary transition-colors">Redmi 10C</Link></li>
            <li aria-hidden="true">/</li>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Redmi 10C Screen Replacement Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Redmi 10C screen replacement using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Redmi 10C Screen Replacement Today
          </h2>
