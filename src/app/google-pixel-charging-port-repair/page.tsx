...
const page = BRAND_SERVICE_BY_SLUG.get('google-pixel-charging-port-repair')!

export const metadata: Metadata = {
  title: page.metaTitle,
  description: page.metaDescription,
  alternates: { canonical: 'https://www.itechrepairs.com.au/google-pixel-charging-port-repair' },
  robots: 'index, follow',
}
