...
export const metadata: Metadata = {
  title: 'OnePlus 7T Pro Battery Replacement Melbourne | From $79',
  description:
    'OnePlus 7T Pro battery replacement in Melbourne starting From $79. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/oneplus-7t-pro-battery-replacement',
  },
  openGraph: {
    title: 'OnePlus 7T Pro Battery Replacement Melbourne | From $79',
    description: 'OnePlus 7T Pro battery replacement Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/oneplus-7t-pro-battery-replacement',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'OnePlus 7T Pro Battery Replacement Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
export default function Oneplus7tProBatteryReplacementPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              OnePlus 7T Pro Battery Replacement Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in OnePlus 7T Pro battery replacement using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your OnePlus 7T Pro Battery Replacement Today
          </h2>
