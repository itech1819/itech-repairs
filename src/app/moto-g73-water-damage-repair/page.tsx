...
export const metadata: Metadata = {
  title: 'Moto G73 Water Damage Repair Melbourne | From $79',
  description:
    'Moto G73 water damage repair in Melbourne starting From $79. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/moto-g73-water-damage-repair',
  },
  openGraph: {
    title: 'Moto G73 Water Damage Repair Melbourne | From $79',
    description: 'Moto G73 water damage repair Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/moto-g73-water-damage-repair',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Moto G73 Water Damage Repair Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
export default function MotoG73WaterDamageRepairPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Moto G73 Water Damage Repair Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Moto G73 water damage repair using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Moto G73 Water Damage Repair Today
          </h2>
