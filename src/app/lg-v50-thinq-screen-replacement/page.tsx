...
export const metadata: Metadata = {
  title: 'LG V50 ThinQ Screen Replacement Melbourne | From $79',
  description:
    'LG V50 ThinQ screen replacement in Melbourne. From $79. Lifetime warranty on parts and labour. Walk in Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/lg-v50-thinq-screen-replacement',
  },
  openGraph: {
    title: 'LG V50 ThinQ Screen Replacement Melbourne | From $79',
    description: 'LG V50 ThinQ screen replacement in Melbourne. From $79. Lifetime warranty. Walk in today.',
    url: 'https://www.itechrepairs.com.au/lg-v50-thinq-screen-replacement',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'LG V50 ThinQ Screen Replacement Melbourne',
  description: 'Professional LG V50 ThinQ screen replacement in Melbourne. Lifetime warranty on parts and labour. Walk in Braybrook or Spotswood.',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
...
const relatedServices = [
      { name: 'Battery Replacement', href: '/lg-v50-thinq-battery-replacement', price: 'From $69' },
      { name: 'Charging Port Repair', href: '/lg-v50-thinq-charging-port-repair', price: 'From $65' },
      { name: 'Water Damage Repair', href: '/lg-v50-thinq-water-damage-repair', price: 'From $79' },
      { name: 'Free Diagnostic', href: '/lg-v50-thinq-free-device-inspection', price: 'Free' },
]

export default function LgV50ThinqScreenReplacementPage() {
  return (
    <>
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-surface border-b border-gray-border py-3">
        <div className="container-page">
          <ol className="flex items-center gap-2 text-sm text-charcoal-light">
            ...
            <li aria-hidden="true">/</li>
            <li><Link href="/lg-v50-thinq-repair" className="hover:text-primary transition-colors">LG V50 ThinQ</Link></li>
            <li aria-hidden="true">/</li>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              LG V50 ThinQ Screen Replacement Melbourne
            </h1>
            <p className="text-xl text-gray-300 mb-6">
              From $79 · Lifetime Warranty · Same Day · Walk In Welcome
            </p>
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              Expert LG V50 ThinQ screen replacement in Melbourne. Walk in to our Braybrook or Spotswood store — no appointment needed. Every repair includes a lifetime warranty on parts and labour.
            </p>
        ...
        <div className="container-page">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-charcoal mb-4">
              LG V50 ThinQ Screen Replacement in Melbourne
            </h2>
            <p className="text-charcoal-light leading-relaxed mb-4">
              Our technicians specialise in LG V50 ThinQ repairs in Melbourne. We use quality replacement parts and follow precise repair procedures so your device works exactly as intended after service.
            </p>
      ...
      <section className="bg-primary text-white py-16">
        <div className="container-page text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Book Your LG V50 ThinQ Screen Replacement Today
          </h2>
