...
export const metadata: Metadata = {
  title: 'Huawei P30 Lite Water Damage Repair Melbourne | From $89',
  description:
    'Huawei P30 Lite water damage repair in Melbourne starting From $89. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/huawei-p30-lite-water-damage-repair',
  },
  openGraph: {
    title: 'Huawei P30 Lite Water Damage Repair Melbourne | From $89',
    description: 'Huawei P30 Lite water damage repair Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/huawei-p30-lite-water-damage-repair',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Huawei P30 Lite Water Damage Repair Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
export default function HuaweiP30LiteWaterDamageRepairPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Huawei P30 Lite Water Damage Repair Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Huawei P30 Lite water damage repair using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Huawei P30 Lite Water Damage Repair Today
          </h2>
