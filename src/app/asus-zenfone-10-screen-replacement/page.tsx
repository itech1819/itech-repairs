...
export const metadata: Metadata = {
  title: 'Asus ZenFone 10 Screen Replacement Melbourne | From $99',
  description:
    'Asus ZenFone 10 screen replacement in Melbourne. From $99. Lifetime warranty on parts and labour. Walk in Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/asus-zenfone-10-screen-replacement',
  },
  openGraph: {
    title: 'Asus ZenFone 10 Screen Replacement Melbourne | From $99',
    description: 'Asus ZenFone 10 screen replacement in Melbourne. From $99. Lifetime warranty. Walk in today.',
    url: 'https://www.itechrepairs.com.au/asus-zenfone-10-screen-replacement',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Asus ZenFone 10 Screen Replacement Melbourne',
  description: 'Professional Asus ZenFone 10 screen replacement in Melbourne. Lifetime warranty on parts and labour. Walk in Braybrook or Spotswood.',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
...
const relatedServices = [
      { name: 'Battery Replacement', href: '/asus-zenfone-10-battery-replacement', price: 'From $79' },
...
export default function AsusZenfone10ScreenReplacementPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Asus ZenFone 10 Screen Replacement Melbourne
            </h1>
            <p className="text-xl text-gray-300 mb-6">
              From $99 · Lifetime Warranty · Same Day · Walk In Welcome
            </p>
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              Expert Asus ZenFone 10 screen replacement in Melbourne. Walk in to our Braybrook or Spotswood store — no appointment needed. Every repair includes a lifetime warranty on parts and labour.
            </p>
        ...
        <div className="container-page">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-charcoal mb-4">
              Asus ZenFone 10 Screen Replacement in Melbourne
            </h2>
      ...
      <section className="bg-primary text-white py-16">
        <div className="container-page text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Book Your Asus ZenFone 10 Screen Replacement Today
          </h2>
