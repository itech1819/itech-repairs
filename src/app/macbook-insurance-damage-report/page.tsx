...
const page = BRAND_SERVICE_BY_SLUG.get('macbook-insurance-damage-report')!

export const metadata: Metadata = {
  title: page.metaTitle,
  description: page.metaDescription,
  alternates: { canonical: 'https://www.itechrepairs.com.au/macbook-insurance-damage-report' },
  robots: 'index, follow',
}
