...
export const metadata: Metadata = {
  title: 'Realme 8 Charging Port Repair Melbourne | From $59',
  description:
    'Realme 8 charging port repair in Melbourne starting From $59. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/realme-8-charging-port-repair',
  },
  openGraph: {
    title: 'Realme 8 Charging Port Repair Melbourne | From $59',
    description: 'Realme 8 charging port repair Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/realme-8-charging-port-repair',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Realme 8 Charging Port Repair Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
const relatedServices = [
  { name: 'Screen Replacement', href: '/realme-8-screen-replacement' },
...
export default function Realme8ChargingPortRepairPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Realme 8 Charging Port Repair Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Realme 8 charging port repair using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Realme 8 Charging Port Repair Today
          </h2>
