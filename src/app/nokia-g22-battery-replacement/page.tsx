...
export const metadata: Metadata = {
  title: 'Nokia G22 Battery Replacement Melbourne | From $59',
  description:
    'Nokia G22 battery replacement in Melbourne. From $59. Lifetime warranty on parts and labour. Walk in Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/nokia-g22-battery-replacement',
  },
  openGraph: {
    title: 'Nokia G22 Battery Replacement Melbourne | From $59',
    description: 'Nokia G22 battery replacement in Melbourne. From $59. Lifetime warranty. Walk in today.',
    url: 'https://www.itechrepairs.com.au/nokia-g22-battery-replacement',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Nokia G22 Battery Replacement Melbourne',
  description: 'Professional Nokia G22 battery replacement in Melbourne. Lifetime warranty on parts and labour. Walk in Braybrook or Spotswood.',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
...
const relatedServices = [
      ...
      { name: 'Charging Port Repair', href: '/nokia-g22-charging-port-repair', price: 'From $55' },
...
export default function NokiaG22BatteryReplacementPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Nokia G22 Battery Replacement Melbourne
            </h1>
            <p className="text-xl text-gray-300 mb-6">
              From $59 · Lifetime Warranty · Same Day · Walk In Welcome
            </p>
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              Expert Nokia G22 battery replacement in Melbourne. Walk in to our Braybrook or Spotswood store — no appointment needed. Every repair includes a lifetime warranty on parts and labour.
            </p>
        ...
        <div className="container-page">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-charcoal mb-4">
              Nokia G22 Battery Replacement in Melbourne
            </h2>
      ...
      <section className="bg-primary text-white py-16">
        <div className="container-page text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Book Your Nokia G22 Battery Replacement Today
          </h2>
