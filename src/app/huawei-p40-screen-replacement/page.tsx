...
export const metadata: Metadata = {
  title: 'Huawei P40 Screen Replacement Melbourne | From $89',
  description:
    'Huawei P40 screen replacement in Melbourne starting From $89. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/huawei-p40-screen-replacement',
  },
  openGraph: {
    title: 'Huawei P40 Screen Replacement Melbourne | From $89',
    description: 'Huawei P40 screen replacement Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/huawei-p40-screen-replacement',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Huawei P40 Screen Replacement Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
const relatedServices = [
  { name: 'Battery Replacement', href: '/huawei-p40-battery-replacement' },
  { name: 'Charging Port Repair', href: '/huawei-p40-charging-port-repair' },
  { name: 'Water Damage Repair', href: '/huawei-p40-water-damage-repair' },
  { name: 'Free Diagnostic', href: '/huawei-p40-free-device-inspection' },
]

export default function HuaweiP40ScreenReplacementPage() {
  return (
    <>
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-surface border-b border-gray-border py-3">
        <div className="container-page">
          <ol className="flex items-center gap-2 text-sm text-charcoal-light">
            ...
            <li aria-hidden="true">/</li>
            <li><Link href="/huawei-p40-repair" className="hover:text-primary transition-colors">Huawei P40</Link></li>
            <li aria-hidden="true">/</li>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Huawei P40 Screen Replacement Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Huawei P40 screen replacement using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Huawei P40 Screen Replacement Today
          </h2>
