...
export const metadata: Metadata = {
  title: 'LG K41 Water Damage Repair Melbourne | From $79',
  description:
    'LG K41 water damage repair in Melbourne starting From $79. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/lg-k41-water-damage-repair',
  },
  openGraph: {
    title: 'LG K41 Water Damage Repair Melbourne | From $79',
    description: 'LG K41 water damage repair Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/lg-k41-water-damage-repair',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'LG K41 Water Damage Repair Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
export default function LgK41WaterDamageRepairPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              LG K41 Water Damage Repair Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in LG K41 water damage repair using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your LG K41 Water Damage Repair Today
          </h2>
