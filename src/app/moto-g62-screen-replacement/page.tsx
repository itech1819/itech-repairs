...
export const metadata: Metadata = {
  title: 'Moto G62 Screen Replacement Melbourne | From $79',
  description:
    'Moto G62 screen replacement in Melbourne starting From $79. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/moto-g62-screen-replacement',
  },
  openGraph: {
    title: 'Moto G62 Screen Replacement Melbourne | From $79',
    description: 'Moto G62 screen replacement Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/moto-g62-screen-replacement',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Moto G62 Screen Replacement Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
const relatedServices = [
  { name: 'Battery Replacement', href: '/moto-g62-battery-replacement' },
  { name: 'Charging Port Repair', href: '/moto-g62-charging-port-repair' },
  { name: 'Water Damage Repair', href: '/moto-g62-water-damage-repair' },
  { name: 'Free Diagnostic', href: '/moto-g62-free-device-inspection' },
]

export default function MotoG62ScreenReplacementPage() {
  return (
    <>
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-surface border-b border-gray-border py-3">
        <div className="container-page">
          <ol className="flex items-center gap-2 text-sm text-charcoal-light">
            ...
            <li aria-hidden="true">/</li>
            <li><Link href="/moto-g62-repair" className="hover:text-primary transition-colors">Moto G62</Link></li>
            <li aria-hidden="true">/</li>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Moto G62 Screen Replacement Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Moto G62 screen replacement using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Moto G62 Screen Replacement Today
          </h2>
