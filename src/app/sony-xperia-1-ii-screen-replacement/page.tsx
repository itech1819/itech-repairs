...
export const metadata: Metadata = {
  title: 'Sony Xperia 1 II Screen Replacement Melbourne | From $99',
  description:
    'Sony Xperia 1 II screen replacement in Melbourne starting From $99. Lifetime warranty on parts and labour. Walk in to Braybrook or Spotswood — no appointment needed.',
  alternates: {
    canonical: 'https://www.itechrepairs.com.au/sony-xperia-1-ii-screen-replacement',
  },
  openGraph: {
    title: 'Sony Xperia 1 II Screen Replacement Melbourne | From $99',
    description: 'Sony Xperia 1 II screen replacement Melbourne. Lifetime warranty.',
    url: 'https://www.itechrepairs.com.au/sony-xperia-1-ii-screen-replacement',
  },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Sony Xperia 1 II Screen Replacement Melbourne',
  provider: {
    '@type': 'LocalBusiness',
    name: 'iTech Repairs',
  },
...
const relatedServices = [
  ...
  { name: 'Water Damage Repair', href: '/sony-xperia-1-ii-water-damage-repair' },
  { name: 'Free Diagnostic', href: '/sony-xperia-1-ii-free-device-inspection' },
]

export default function SonyXperia1IiScreenReplacementPage() {
  return (
    <>
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Sony Xperia 1 II Screen Replacement Melbourne
            </h1>
      ...
      <section className="section-padding bg-white">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-charcoal-light mb-4">
            Our technicians specialise in Sony Xperia 1 II screen replacement using
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-page max-w-2xl">
          <h2 className="text-2xl font-bold mb-4">
            Book Your Sony Xperia 1 II Screen Replacement Today
          </h2>
